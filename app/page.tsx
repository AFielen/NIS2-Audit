  ...
  return (
    <div style={{ background: 'var(--bg)' }} className="min-h-[calc(100vh-theme(spacing.16))] py-8 px-4">
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <div className="drk-card drk-fade-in">
          <div className="flex items-start gap-4">
            <div className="p-3 rounded-xl shrink-0" style={{ background: 'var(--success-bg)', color: 'var(--success)' }}>
              <ClipboardCheckIcon />
            </div>
            <div>
              ...
              <p className="text-sm mb-3" style={{ color: 'var(--text-light)' }}>
                Richtlinien, Risikoanalysen und Nachweise strukturiert aufbauen — das
                Dokumentations-Tool für Ihr Informationssicherheits-Managementsystem.
                Perfekte Ergänzung zum NIS-2 Audit.
              </p>
              <a
                href={process.env.NEXT_PUBLIC_ISMS_URL || 'https://drk-isms.de'}
                target="_blank"
        ...
        <div className="drk-card drk-fade-in">
          <div className="flex items-start gap-4">
            <div className="p-3 rounded-xl shrink-0" style={{ background: 'var(--info-bg)', color: 'var(--info)' }}>
              <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" viewBox="0 0 24 24"
                   fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
              </svg>
