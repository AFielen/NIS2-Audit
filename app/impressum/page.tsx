        ...
        <div className="drk-card">
          ...
          <div className="space-y-6" style={{ color: 'var(--text-light)' }}>
            ...
            <section>
              ...
              <p>
                Die Ergebnisse dieses Tools stellen keine Rechtsberatung dar. Sie dienen als erste Orientierung
                zur NIS-2-Betroffenheit und ersetzen keine individuelle juristische Prüfung. Für verbindliche
                Aussagen konsultieren Sie bitte einen spezialisierten Rechtsberater.
              </p>
            </section>
          </div>
